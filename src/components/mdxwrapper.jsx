    ...
    <>
      ...
      <div className="p-5 lg:px-48 2xl:px-96 lg:py-10 2xl:py-20">
        <div className=' flex flex-auto gap-x-4 '>
          {meta.thumbnail
              ? <figure className='mt-20 mb-6 relative h-12 lg:h-20 aspect-square'><Image className='rounded-full' fill src={`/articles/${meta.filename}/thumbnail.jpg`} alt={meta.title} /></figure>
