    ...
    <>
      <main className='min-h-screen flex flex-col lg:flex-row justify-between items-center'>
          <div className="hero min-h-screen bg-gradient-to-t from-base-100 to-base-200">
            <div className="hero-content gap-6 max-w-full w-auto p-0 lg:p-1 lg:px-20 xl:px-40 flex-col-reverse lg:flex-row">
                <div className="mx-auto max-w-xs md:max-w-xl lg:max-w-2xl text-center text-base-content">
                  ...
                  <Link href="/resume#top" className="btn btn-primary lg:btn-lg lg:text-xl border-0 bg-gradient-to-br from-primary to-secondary hover:from-primary-focus hover:to-secondary-focus">Let&apos;s Go!</Link>
                </div>
