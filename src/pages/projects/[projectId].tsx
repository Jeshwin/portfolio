      ...
      <div className="p-5 lg:px-48 2xl:px-96 lg:py-10 2xl:py-20">
        <div className="text-xl leading-loose">
          <div className="flex flex-row items-center gap-4 pb-12">
            ...
            />
            <div className="text-8xl font-bold mt-4">{data.title}</div>
          </div>
          <ul className="flex gap-3 mb-8">
            {data.tags.map((tag) => (
              <li key={tag.title} className="badge badge-lg badge-primary p-4">
                {tag.title}
              </li>
            ))}
          </ul>
          <div className="text-4xl font-semibold pb-8">Description</div>
          <div className="text-xl pb-8">{data.description}</div>
          <div className="text-4xl font-semibold pb-8">Relevant Links</div>
              ...
              >
                <a href={gal.image}>
                  ...
                  <div className="card-body text-center">
                    <p className="text-2xl">{gal.description}</p>
                  </div>
                </a>
              </li>
            ))}
